...
static const ssl_ciphersuite_t ciphersuite_definitions[] =
{
...
#if defined(__TTS__)
    { TLS_ECDHE_TTS_WITH_AES_128_GCM_SHA256, "TLS-ECDHE-TTS-WITH-AES-128-GCM-SHA256",
      POLARSSL_CIPHER_AES_128_GCM, POLARSSL_MD_SHA256, OUR_KEY_EXCHANGE_ECDHE_TTS,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      0 },
#endif
...
#if defined(__TTS__)
    { TLS_LATTICEE_TTS_WITH_AES_128_GCM_SHA256, "TLS-LATTICEE-TTS-WITH-AES-128-GCM-SHA256",
      POLARSSL_CIPHER_AES_128_GCM, POLARSSL_MD_SHA256, OUR_KEY_EXCHANGE_LATTICEE_TTS,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      0 },
#endif
    ...
    { TLS_LATTICEE_RAINBOW_WITH_AES_128_GCM_SHA256, "TLS-LATTICEE-RAINBOW-WITH-AES-128-GCM-SHA256",
      POLARSSL_CIPHER_AES_128_GCM, POLARSSL_MD_SHA256, OUR_KEY_EXCHANGE_LATTICEE_RAINBOW,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      0 },
#endif
    ...
    { TLS_LATTICEE_TTS2_WITH_AES_128_GCM_SHA256, "TLS-LATTICEE-TTS2-WITH-AES-128-GCM-SHA256",
      POLARSSL_CIPHER_AES_128_GCM, POLARSSL_MD_SHA256, OUR_KEY_EXCHANGE_LATTICEE_TTS2,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      0 },
#endif
    ...
    { TLS_LATTICEE_RAINBOW2_WITH_AES_128_GCM_SHA256, "TLS-LATTICEE-RAINBOW2-WITH-AES-128-GCM-SHA256",
      POLARSSL_CIPHER_AES_128_GCM, POLARSSL_MD_SHA256, OUR_KEY_EXCHANGE_LATTICEE_RAINBOW2,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      0 },
#endif

    { TLS_LATTICEE_RSA_WITH_AES_128_GCM_SHA256, "TLS-LATTICEE-RSA-WITH-AES-128-GCM-SHA256",
      POLARSSL_CIPHER_AES_128_GCM, POLARSSL_MD_SHA256, OUR_KEY_EXCHANGE_LATTICEE_RSA,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      0 },

    { TLS_LATTICEE_ECDSA_WITH_AES_128_GCM_SHA256, "TLS-LATTICEE-ECDSA-WITH-AES-128-GCM-SHA256",
      POLARSSL_CIPHER_AES_128_GCM, POLARSSL_MD_SHA256, OUR_KEY_EXCHANGE_LATTICEE_ECDSA,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      0 },
#endif /* defined(LATTICE_LWEDH_C)*/

#if defined(NACL_CV25519_C)
#if defined(__TTS__)
    { TLS_CV25519E_TTS_WITH_AES_128_GCM_SHA256, "TLS-CV25519E-TTS-WITH-AES-128-GCM-SHA256",
      POLARSSL_CIPHER_AES_128_GCM, POLARSSL_MD_SHA256, OUR_KEY_EXCHANGE_CV25519E_TTS,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      SSL_MAJOR_VERSION_3, SSL_MINOR_VERSION_3,
      0 },
#endif
#endif /* defined(NACL_CV25519_C) */
...
{POLARSSL_KEY_EXCHANGE_ECDH_RSA,POLARSSL_DH_EC,POLARSSL_PK_RSA,0,0},
{POLARSSL_KEY_EXCHANGE_ECDH_ECDSA,POLARSSL_DH_EC,POLARSSL_PK_ECDSA,0,0},

{OUR_KEY_EXCHANGE_ECDHE_TTS,POLARSSL_DH_EC,OUR_PK_TTS,0,0},
{OUR_KEY_EXCHANGE_ECDHE_RAINBOW,POLARSSL_DH_EC,OUR_PK_RAINBOW,0,0},

{OUR_KEY_EXCHANGE_LATTICEE_TTS,POLARSSL_DH_LWE,OUR_PK_TTS,0,0},
{OUR_KEY_EXCHANGE_LATTICEE_RAINBOW,POLARSSL_DH_LWE,OUR_PK_RAINBOW,0,0},
{OUR_KEY_EXCHANGE_LATTICEE_RSA,POLARSSL_DH_LWE,POLARSSL_PK_RSA,0,0},
{OUR_KEY_EXCHANGE_LATTICEE_ECDSA,POLARSSL_DH_LWE,POLARSSL_PK_ECDSA,0,0},
{OUR_KEY_EXCHANGE_LATTICEE_TTS2,POLARSSL_DH_LWE,OUR_PK_TTS2,0,0},
{OUR_KEY_EXCHANGE_LATTICEE_RAINBOW2,POLARSSL_DH_LWE,OUR_PK_RAINBOW2,0,0},

{OUR_KEY_EXCHANGE_CV25519E_TTS,NACL_DH_CV25519,OUR_PK_TTS,0,0},
{OUR_KEY_EXCHANGE_CV25519E_RAINBOW,NACL_DH_CV25519,OUR_PK_RAINBOW,0,0},
{OUR_KEY_EXCHANGE_CV25519E_RSA,NACL_DH_CV25519,POLARSSL_PK_RSA,0,0},
{OUR_KEY_EXCHANGE_CV25519E_ECDSA,NACL_DH_CV25519,POLARSSL_PK_ECDSA,0,0},
