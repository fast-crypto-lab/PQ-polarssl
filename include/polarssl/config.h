...
/**
 * \def POLARSSL_KEY_EXCHANGE_LATTICEE_TTS _ENABLED
 *
 * Enable the LATTICE based ciphersuites modes in SSL / TLS.
 *
 * Requires: POLARSSL_ECDH_C, POLARSSL_X509_CRT_PARSE_C
 *
 * These enables the following ciphersuites (if other requisites are
 * enabled as well):
 *      TLS_LATTICEE_TTS_WITH_AES_128_GCM_SHA256
 *      TLS_LATTICEE_RAINBOW_WITH_AES_128_GCM_SHA256
 *      TLS_LATTICEE_RSA_WITH_AES_128_GCM_SHA256
 *      TLS_LATTICEE_ECDSA_WITH_AES_128_GCM_SHA256
 *      TLS_LATTICEE_TTS2_WITH_AES_128_GCM_SHA256
 *      TLS_LATTICEE_RAINBOW2_WITH_AES_128_GCM_SHA256
 */
#define POLARSSL_KEY_EXCHANGE_LATTICEE_TTS _ENABLED
#define POLARSSL_KEY_EXCHANGE_LATTICEE_RAINBOW_ENABLED
#define POLARSSL_KEY_EXCHANGE_LATTICEE_RSA_ENABLED
#define POLARSSL_KEY_EXCHANGE_LATTICEE_ECDSA _ENABLED
#define POLARSSL_KEY_EXCHANGE_LATTICEE_TTS2 _ENABLED
#define POLARSSL_KEY_EXCHANGE_LATTICEE_RAINBOW2_ENABLED
