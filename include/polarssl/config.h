 ...
 */
#define POLARSSL_KEY_EXCHANGE_LATTICEE_TTS_ENABLED
#define POLARSSL_KEY_EXCHANGE_LATTICEE_RAINBOW_ENABLED
#define POLARSSL_KEY_EXCHANGE_LATTICEE_RSA_ENABLED
#define POLARSSL_KEY_EXCHANGE_LATTICEE_ECDSA_ENABLED
#define POLARSSL_KEY_EXCHANGE_LATTICEE_TTS2_ENABLED
